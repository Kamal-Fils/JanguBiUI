...
export default function EditArticlePage() {
  ...
  const { data: article, isLoading: articleLoading } = useAdminArticleDetail(params.id);
      ...
      <div className="flex flex-col">
        ...
        <div className="mx-auto w-full max-w-3xl px-4 py-6 md:px-6">
          ...
          {articleLoading ? (
            ...
            // n'est pas éditable ici — on l'exclut explicitement (narrow le type
            // scope_type pour ArticleForm, et évite toute corruption de la donnée).
            <div className="py-20 text-center text-sm text-muted-foreground">
